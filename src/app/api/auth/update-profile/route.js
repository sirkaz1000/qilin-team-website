...
export async function PATCH(request) {
  try {
    ...
    if (displayName !== undefined) {
      users[userIndex].displayName = sanitizeInput(displayName.trim())
    ...
    if (username !== undefined) {
      ...
      users[userIndex].username = sanitizeInput(username.trim())
      console.log('Updated username')
    }

    if (avatarUrl !== undefined) {
      users[userIndex].avatarUrl = sanitizeInput(avatarUrl.trim())
